      ...
      <View style={globalStyles.container}>
        ...
        <View style={globalStyles.body}>
          ...
          <View style={globalStyles.bodyContainer}>
            <Image
              style={styles.imageGraphics}
              source={require("../assets/Device.png")}
            />
          </View>
          <View style={globalStyles.bodyContainer}>
            <Text style={styles.text}>
              1. Go to your phone's WiFi settings and connect to the device's
              WiFi hotspot
            </Text>

            <Text style={styles.text}>
              2. Hit the Already Connected button below.
            </Text>
          </View>
          <TouchableOpacity
            style={globalStyles.bodyButton}
            onPress={() => this.props.navigation.navigate("Device_Connecting")}
          >
